...
class CustomVisitor(MinGQLVisitor):
    ...
    def _iter_method(
        self,
        ctx: Union[MinGQLParser.Map_gqlContext, MinGQLParser.Filter_gqlContext],
        method="map",
    ):
        ...
        for elem in iterable.data:
            ...
            if method == "map":
                ...
                raise NotImplementedError(
                    f"CustomVisitor._iter_method wrong method {method}"
                )
    ...
    def _modify_states(
        self,
        ctx: Union[
            MinGQLParser.Set_startContext,
            MinGQLParser.Add_startContext,
            MinGQLParser.Set_finalContext,
            MinGQLParser.Add_finalContext,
        ],
        modify_method=None,
    ):
    ...
    def _get_graph_info(
        self,
        ctx: Union[
            MinGQLParser.Get_edgesContext,
            MinGQLParser.Get_labelsContext,
            MinGQLParser.Get_startContext,
            MinGQLParser.Get_finalContext,
            MinGQLParser.Get_verticesContext,
            MinGQLParser.Get_reachableContext,
        ],
        info_method=None,
    ):
